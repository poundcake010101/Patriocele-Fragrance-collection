// Supabase configuration - Using YOUR actual project details
...
// Create Supabase client - use var for hoisting or ensure proper loading order
...
async function testConnection() {
    try {
        ...
        if (error) {
            console.warn('Supabase connection test failed (this is normal if tables dont exist yet):', error.message);
        } else {
